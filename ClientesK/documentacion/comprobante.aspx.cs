...
public partial class documentacion_comprobante : System.Web.UI.Page
{
    ...
    private void cargar_grid()
    {
        ...
        try
        {
            Tabla tbEmpresas = Manejador.getEjecutaStoredProcedure1("getDocumentosBase", (cboarea.SelectedIndex + 1) + "|" + (cboempresas.SelectedValue));
            if (tbEmpresas != null)
            {
